    ...
    return [
        {
            table: {
                ...
                body: [
                    [
                        { text: "แยกราย\nประเภท", alignment: "center", bold: true, fillColor: "#AAAB92" },
                        { text: "บุคคลธรรมดา", alignment: "center", bold: true, fillColor: "#AAAB92",margin: [0, 10, 0, 10] },
                        { text: "ห้างหุ้นส่วนสามัญ\n(ไม่จดทะเบียน)", alignment: "center", bold: true, fillColor: "#AAAB92" },
                        { text: "ห้างหุ้นส่วนสามัญ\n(จดทะเบียน)", alignment: "center", bold: true, fillColor: "#AAAB92" },
                        { text: "ห้างหุ้นส่วนจำกัด", alignment: "center", bold: true, fillColor: "#AAAB92",margin: [0, 10, 0, 10]  },
                        { text: "บริษัทจำกัด", alignment: "center", bold: true, fillColor: "#AAAB92",margin: [0, 10, 0, 10]  },
                        { text: "บริษัทมหาชนจำกัด", alignment: "center", bold: true, fillColor: "#AAAB92",margin: [0, 10, 0, 10]  },
                    ],
                    ...
                    [
                        { text: "#", alignment: "center" },
                        { text: "ทนายความ", colSpan: 2,  alignment: "center", bold: true, fillColor: "#AAAB92" },
                        "",
                        { text: "1", alignment: "center" },
                        { text: "สภาทนายความ", colSpan: 2, alignment: "center", bold: true, fillColor: "#AAAB92" },
                        "",
                        { text: "1", alignment: "center" },
                    ],
                    [
                        { text: "#", alignment: "center" },
                        { text: "ผู้ประกอบธุรกิจที่เป็นบุคคลธรรมดา", colSpan: 2, alignment: "center", bold: true, fillColor: "#d4d4b0" },
                        "",
                        { text: "1", alignment: "center" },
                        { text: "ผู้ประกอบธุรกิจที่เป็นนิติบุคคล", colSpan: 2, alignment: "center", bold: true, fillColor: "#d4d4b0" },
                        "",
                        { text: "1", alignment: "center" },
                    ],
                    [
                        { text: "รวม", colSpan: 2, alignment: "center", bold: true, fillColor: "#D9D9D9" },
                        "",
                        { text: "15", colSpan: 5, alignment: "center", fillColor: "#D9D9D9" },
                        "",
                        "",
                        "",
                        "",
