...
const searchQuery = ref('') // ใช้เก็บข้อความในช่องค้นหา
...
const items = reactive([
  {
    ...
    type: 'ขอเปลี่ยนบัญชีรายชื่อพนักงานของผู้ประกอบธุรกิจทวงถามหนี้',
    status: 1,
  },
  {
    date: '21/11/2567',
    name: 'บริษัท ทดสอบ จำกัด',
    type: 'ขอเปลี่ยนพนักงานในบัญชี',
    status: 0,
  },
  {
    date: '22/11/2567',
    name: 'บริษัท ทดสอบ กรุ๊ป จำกัด',
    type: 'ขอเปลี่ยนแปลงข้อมูลพนักงาน',
    status: 1,
  },
])
