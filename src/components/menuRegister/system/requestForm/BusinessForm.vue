      ...
      <v-card-text class="py-6">
        <v-form ref="form">
          <v-row>
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">วันหมดอายุ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row>
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">คำนำหน้านาม</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="6" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">ชื่อ-สกุล</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row>
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">สัญชาติ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
