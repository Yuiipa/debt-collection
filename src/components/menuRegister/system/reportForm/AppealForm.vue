        ...
        <v-form ref="form">
          ...
          <v-row>
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">คำนำหน้าชื่อ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">ชื่อ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">นามสกุล</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">อายุ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row>
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">บ้านเลขที่</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">ถนน/ซอย</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row>
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">อำเภอ</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
            ...
            <v-col cols="12" md="3" class="pa-0">
              <div class="v-col-12 py-0 font-weight-bold">ตำบล</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row class="mt-6">
            <v-col cols="12" md="12" class="py-0 px-0">
              <div class="v-col-12 py-0 font-weight-bold">ข้อร้องเรียน</div>
              <v-text-field
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row class="mt-6">
            <v-col cols="12" md="12" class="py-0 px-0">
              <div class="v-col-12 py-0 font-weight-bold">เหตุที่เกิด</div>
              <v-textarea
                class="v-col-12"
                variant="outlined"
                density="compact"
          ...
          <v-row class="mt-6">
            <v-col cols="12" md="12" class="py-0 px-0">
              <div class="v-col-12 py-0 font-weight-bold">อื่นๆ (ถ้ามี)</div>
              <v-textarea
                class="v-col-12"
                variant="outlined"
                density="compact"
